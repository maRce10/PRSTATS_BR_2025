...
The suwo function [`query_xenocanto()`](https://marce10.github.io/warbleR/reference/query_xc.html) queries for animal vocalization recordings in the open-access online repository [Xeno-Canto](https://xeno-canto.org) ([check here which taxonomic groups are available](https://xeno-canto.org/explore/taxonomy)). The function returns recordings metadata which can be later used to download the associated sound files.
