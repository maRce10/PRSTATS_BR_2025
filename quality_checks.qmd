...
```{r, echo = FALSE}
unlink("./examples/consolidated_files", recursive = TRUE)
```
...
## Homogenize extended selection tables
...
```
```{r, echo = FALSE}
unlink("./examples/corrupted_file.wav")
```

 

# Optimizing spectrograms
