...
4)  Make a directory called "BIACOUSTICS_R_2025" (or any name you want), this will be your working directory for the course.
...
8) Download [this folder](https://www.dropbox.com/scl/fo/5vs5t8ew5ciza0i0m08rj/AL-V_t_ehq1AqaGsK1WH42c?rlkey=0kuuqo5xmfsac0tfmnnyg37e3&st=emmh6sr9&dl=0) within the Rstudio project directory. Make sure is saved as a subfolder called "examples"

9)  Now in the R console in Rstudio: Run the following code to install the latest developmental versions (from github) of warbleR, Rraven, PhenotypeSpace, ohun, baRulho and dynaSpec (remove the packages first if you have them installed already).
...
1) Install ffmpeg (only needed for dynaSpec package):
...
2) Install Audacity (you can use Adobe Audition instead):

<https://www.audacityteam.org/download/>

3) Install SOX. It can be downloaded from here: 

[http://sox.sourceforge.net](http://sox.sourceforge.net/)

4) Install FLAC. It can be downloaded from here: 
